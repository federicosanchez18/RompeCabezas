...
var instrucciones = ["Encontrar el orden correcto de la imagen","Mover las piezas"];
...
// Funciones axusiliares 
//retorna true si 2 elementos son iguales
function mismoElemento(e1,e2){
   return e1 == e2;
}

function esMismoArray(array1, array2) {
  for (var i = 0; i < array1.length; i++) {
      if (!mismoElemento(array1[i], array2[i])) {
          return false;
      }
  }
  return true;
...
//retorna true si 2 array son iguales (mismo elemento y mismo orden) / asumo que los 2 array son iguales
//function esMismoArray(array1,array2){
//  var resultado = false;
//    for (var i = 0 ; i< array1.length ; i++){
//           if(mismoElemento(array1[i],array2[i])){
...
function chequearSiGano() {
  ...
  for (var i = 0; i < grilla.length; i++) {
      if (!esMismoArray(grilla[i], grillaObj[i])) {
          return false;
      }
  }
  return true;
...
function mostrarCartelGanador() {
  alert("Bien hecho , ganaste el juego!!. Reclamar el premio a Acamica");
}
